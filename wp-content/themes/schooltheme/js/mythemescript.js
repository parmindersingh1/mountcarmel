...
( function( $ ) {  
	...
	$("#tab2").click(function(e){	   
	   ...
	   $("#tab3").removeClass("selected_tab");
           $(".tab_read_more").empty();
	   $(".tab_read_more").append("<p><a href='http://localhost/mountcarmel/why-mount-carmel-school/'>Read Full Message</a></p>");
         });
	...
	$("#tab3").click(function(e){            
	   ...
	   $("#tab1").removeClass("selected_tab"); 
	   $(".tab_read_more").empty();
	  $(".tab_read_more").append("<p><a href='http://localhost/mountcarmel/circulars-2'>Read Full Message</a></p>");
         });
...
var date=$('#homework_date').val();
 ...
 $.ajax({
  type: 'POST',
  url: 'http://localhost/mountcarmel/wp-admin/admin-ajax.php',
  data: {
