...
if (function_exists('register_sidebar')) {
    	register_sidebar(array(
    		...
    		'before_widget' => '<div id="welcome-content" class="welcome-message">',
    		'after_widget'  => '</div>',
    		'before_title'  => '<h2>',
    		'after_title'   => '</h2>'
    	));
...
if (function_exists('register_sidebar')) {
    	register_sidebar(array(
    		...
    		'id'   => 'footer-widgets',
    		'description'   => 'Widget Area',
    		'before_widget' => '<div id="contact_info" class="contact_details">',
    		'after_widget'  => '</div>',
    		'before_title'  => '<h2>',
    		'after_title'   => '</h2>'
    	));
...
function twentytwelve_content_nav( $html_id ) {
	...
	if ( $wp_query->max_num_pages > 1 ) : ?>
		<nav id="<?php echo $html_id; ?>" class="navigation" role="navigation">
			...
			<div class="nav-previous alignleft"><?php next_posts_link( __( '<span class="meta-nav"></span>« Previous', 'twentytwelve' ) ); ?></div>
			<div class="nav-next alignright"><?php previous_posts_link( __( 'Next »<span class="meta-nav"></span>', 'twentytwelve' ) ); ?></div>
...
function twentytwelve_customize_preview_js() {
	wp_enqueue_script( 'twentytwelve-customizer', get_template_directory_uri() . '/js/theme-customizer.js', array( 'jquery-ui-core', 'jquery-ui-tabs' ), false, false );
}
...
{
   wp_enqueue_script('my-custom-script', get_template_directory_uri() . '/js/mythemescript.js',array('jquery'),'1.0',true);
}
...
function MyAjaxFunction2(){
  ...
  // creating Ajax call for WordPress
   add_action( 'wp_ajax_nopriv_MyAjaxFunction2', 'MyAjaxFunction2' );
   add_action( 'wp_ajax_MyAjaxFunction2', 'MyAjaxFunction2' );

/* custom setting http://themefoundation.com/wordpress-theme-customizer/*/
...
$wp_customize->add_control(
    ...
    array(
        'type' => 'checkbox',
        'label' => 'Hide slider on internal Pages',
